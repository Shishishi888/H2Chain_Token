...
namespace AElf.Contracts.TokenHolder {
  ...
  internal static partial class TokenHolderContractContainer
  {
    ...
    public class TokenHolderContractReferenceState : global::AElf.Sdk.CSharp.State.ContractReferenceState
    {
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.CreateTokenHolderProfitSchemeInput, global::Google.Protobuf.WellKnownTypes.Empty> CreateScheme { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.AddTokenHolderBeneficiaryInput, global::Google.Protobuf.WellKnownTypes.Empty> AddBeneficiary { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.RemoveTokenHolderBeneficiaryInput, global::Google.Protobuf.WellKnownTypes.Empty> RemoveBeneficiary { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.ContributeProfitsInput, global::Google.Protobuf.WellKnownTypes.Empty> ContributeProfits { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.DistributeProfitsInput, global::Google.Protobuf.WellKnownTypes.Empty> DistributeProfits { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.RegisterForProfitsInput, global::Google.Protobuf.WellKnownTypes.Empty> RegisterForProfits { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Types.Address, global::Google.Protobuf.WellKnownTypes.Empty> Withdraw { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.ClaimProfitsInput, global::Google.Protobuf.WellKnownTypes.Empty> ClaimProfits { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Types.Address, global::AElf.Contracts.TokenHolder.TokenHolderProfitScheme> GetScheme { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.TokenHolder.ClaimProfitsInput, global::AElf.Contracts.TokenHolder.ReceivedProfitsMap> GetProfitsMap { get; set; }
    }
  }
}
#endregion
