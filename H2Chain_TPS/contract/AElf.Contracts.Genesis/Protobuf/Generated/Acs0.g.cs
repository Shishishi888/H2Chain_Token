...
namespace AElf.Standards.ACS0 {
  ...
  public static partial class Acs0Reflection {
  ...
  public sealed partial class ContractDeploymentInput : pb::IMessage<ContractDeploymentInput> {
  ...
  public sealed partial class SystemContractDeploymentInput : pb::IMessage<SystemContractDeploymentInput> {
    ...
    public static partial class Types {
      public sealed partial class SystemTransactionMethodCall : pb::IMessage<SystemTransactionMethodCall> {
      ...
      public sealed partial class SystemTransactionMethodCallList : pb::IMessage<SystemTransactionMethodCallList> {
  ...
  public sealed partial class ContractUpdateInput : pb::IMessage<ContractUpdateInput> {
  ...
  public sealed partial class ContractCodeCheckInput : pb::IMessage<ContractCodeCheckInput> {
  ...
  public sealed partial class ContractProposed : pb::IMessage<ContractProposed> {
  ...
  public sealed partial class ContractDeployed : pb::IMessage<ContractDeployed> {
  ...
  public sealed partial class CodeCheckRequired : pb::IMessage<CodeCheckRequired> {
  ...
  public sealed partial class CodeUpdated : pb::IMessage<CodeUpdated> {
  ...
  public sealed partial class ValidateSystemContractAddressInput : pb::IMessage<ValidateSystemContractAddressInput> {
  ...
  public sealed partial class ReleaseContractInput : pb::IMessage<ReleaseContractInput> {
