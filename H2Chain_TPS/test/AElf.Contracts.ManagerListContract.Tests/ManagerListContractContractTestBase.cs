...
{
    public class ManagerListContractContractTestBase : ContractTestKit.ContractTestBase<ManagerListContractContractTestAElfModule>
    {
        ...
        protected byte[] ManagerListContractCode => Codes.Single(kv => kv.Key.Contains("ManagerListContract")).Value;
        ...
        protected Address ManagerListContractContractAddress { get; set; }
        ...
        internal ManagerListContractContractImplContainer.ManagerListContractContractImplStub ManagerListContractContractStub { get; set; }
        ...
        protected void InitializeContracts()
        {
            ...
            //deploy ManagerListContract contract
            ManagerListContractContractAddress = AsyncHelper.RunSync(() =>
                DeploySystemSmartContract(
                    KernelConstants.CodeCoverageRunnerCategory,
                    ManagerListContractCode,
                    ManagerListContractSmartContractAddressNameProvider.Name,
        ...
        internal ManagerListContractContractImplContainer.ManagerListContractContractImplStub GetManagerListContractContractTester(
            ECKeyPair keyPair)
        {
            return GetTester<ManagerListContractContractImplContainer.ManagerListContractContractImplStub>(ManagerListContractContractAddress,
                keyPair);
        }
        ...
        internal async Task InitializeManagerListContractContracts()
        {
            await ManagerListContractContractStub.Initialize.SendAsync(new InitializeInput());
        }
    }

    public class ManagerListContractContractPrivilegeTestBase : TestBase.ContractTestBase<ManagerListContractContractPrivilegeTestAElfModule>
    {
        ...
        protected new ContractTester<ManagerListContractContractPrivilegeTestAElfModule> Tester;


        public ManagerListContractContractPrivilegeTestBase()
        {
            var mainChainId = ChainHelper.ConvertBase58ToChainId("AELF");
            var chainId = ChainHelper.GetChainId(1);
            Tester = new ContractTester<ManagerListContractContractPrivilegeTestAElfModule>(chainId,SampleECKeyPairs.KeyPairs[1]);
            AsyncHelper.RunSync(() =>
            ...
            ManagerListContractAddress = Tester.GetContractAddress(ManagerListContractSmartContractAddressNameProvider.Name);
        ...
        internal CreateProposalInput CreateManagerListContractProposalInput(IMessage input, Address organizationAddress)
        {
            var createProposalInput = new CreateProposalInput
            {
                ContractMethodName = nameof(ManagerListContractContractImplContainer.ManagerListContractContractImplStub.ChangeOrganizationProposerWhiteList),
                ToAddress = ManagerListContractAddress,
                Params = input.ToByteString(),
                ExpiredTime =  DateTime.UtcNow.AddDays(1).ToTimestamp(),
                OrganizationAddress = organizationAddress
            };
