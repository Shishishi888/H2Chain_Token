...
namespace AElf.Contracts.Treasury {
  ...
  public sealed partial class DonateAllInput : pb::IMessage<DonateAllInput> {
  ...
  public sealed partial class MinerReElectionInformation : pb::IMessage<MinerReElectionInformation> {
  ...
  public sealed partial class DividendPoolWeightSetting : pb::IMessage<DividendPoolWeightSetting> {
  ...
  public sealed partial class MinerRewardWeightSetting : pb::IMessage<MinerRewardWeightSetting> {
  ...
  public sealed partial class SchemeProportionInfo : pb::IMessage<SchemeProportionInfo> {
  ...
  public sealed partial class DividendPoolWeightProportion : pb::IMessage<DividendPoolWeightProportion> {
  ...
  public sealed partial class MinerRewardWeightProportion : pb::IMessage<MinerRewardWeightProportion> {
  ...
  public sealed partial class RecordMinerReplacementInput : pb::IMessage<RecordMinerReplacementInput> {
