...
namespace AElf.Contracts.Parliament {
  ...
  internal static partial class ParliamentContractContainer
  {
    ...
    public class ParliamentContractReferenceState : global::AElf.Sdk.CSharp.State.ContractReferenceState
    {
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.Parliament.InitializeInput, global::Google.Protobuf.WellKnownTypes.Empty> Initialize { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.Parliament.CreateOrganizationInput, global::AElf.Types.Address> CreateOrganization { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.Parliament.ProposalIdList, global::Google.Protobuf.WellKnownTypes.Empty> ApproveMultiProposals { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.Parliament.CreateOrganizationBySystemContractInput, global::AElf.Types.Address> CreateOrganizationBySystemContract { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Types.Address, global::AElf.Contracts.Parliament.Organization> GetOrganization { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::Google.Protobuf.WellKnownTypes.Empty, global::AElf.Types.Address> GetDefaultOrganizationAddress { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Types.Address, global::Google.Protobuf.WellKnownTypes.BoolValue> ValidateAddressIsParliamentMember { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::Google.Protobuf.WellKnownTypes.Empty, global::AElf.Standards.ACS3.ProposerWhiteList> GetProposerWhiteList { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.Parliament.ProposalIdList, global::AElf.Contracts.Parliament.ProposalIdList> GetNotVotedPendingProposals { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.Parliament.ProposalIdList, global::AElf.Contracts.Parliament.ProposalIdList> GetNotVotedProposals { get; set; }
      internal global::AElf.Sdk.CSharp.State.MethodReference<global::AElf.Contracts.Parliament.CreateOrganizationInput, global::AElf.Types.Address> CalculateOrganizationAddress { get; set; }
    }
  }
}
#endregion
